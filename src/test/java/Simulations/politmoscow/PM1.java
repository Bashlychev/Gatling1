...
//        Установки
                ...
                setUp(
                        scnPM01.injectClosed(
                                constantConcurrentUsers(users_flood_PM01).during(40000)
                        ).protocols(httpProtocol_MainPage)
                        ,
                        scnPM02.injectClosed(
                                constantConcurrentUsers(users_flood_PM02).during(40000)
                        ).protocols(httpProtocol_DistGol)
                        ,
                        scnPM03.injectClosed(
                                constantConcurrentUsers(users_flood_PM03).during(40000)
                        ).protocols(httpProtocol_VyboryDuma)
                        ,
                        scnPM04.injectClosed(
                                constantConcurrentUsers(users_flood_PM04).during(40000)
                        ).protocols(httpProtocol_IzbUch)
                        ,
                        scnPM05.injectClosed(
                                constantConcurrentUsers(users_flood_PM05).during(40000)
                        ).protocols(httpProtocol_Candidates)
                        ,
                        scnPM06.injectClosed(
                                constantConcurrentUsers(users_flood_PM06).during(40000)
                        ).protocols(httpProtocol_CandidatesMun)
                        ,
                        scnPM07.injectClosed(
                                constantConcurrentUsers(users_flood_PM07).during(40000)
                        ).protocols(httpProtocol_ShtabPhoto1)
                        ,
                        scnPM08.injectClosed(
                                constantConcurrentUsers(users_flood_PM08).during(40000)
                        ).protocols(httpProtocol_News1)
                        ,
                        scnPM09.injectClosed(
                                constantConcurrentUsers(users_flood_PM09).during(40000)
                        ).protocols(httpProtocol_News2)
                        ,
                        scnPM10.injectClosed(
                                constantConcurrentUsers(users_flood_PM10).during(40000)
                        ).protocols(httpProtocol_News3)
                        ,
                        scnPM11.injectClosed(
                                constantConcurrentUsers(users_flood_PM11).during(40000)
                        ).protocols(httpProtocol_News4)
                        ,
                        scnPM12.injectClosed(
                                constantConcurrentUsers(users_flood_PM12).during(40000)
                        ).protocols(httpProtocol_News5)
                        ,
                        scnPM13.injectClosed(
                                constantConcurrentUsers(users_flood_PM13).during(40000)
                        ).protocols(httpProtocol_Videonew)
                        ,
                        scnPM14.injectClosed(
                                constantConcurrentUsers(users_flood_PM14).during(40000)
